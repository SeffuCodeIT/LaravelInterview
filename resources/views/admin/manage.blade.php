                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <a href="{{url("manage")}}" class="btn btn-primary">Manage Product</a>
                                </div>
                            </div>
                                ...
                                @foreach ($product as $products)
                                    <tr>
                                        ...
                                        <td style="display: flex; padding: 10px; ">
                                            <form action="{{url('editProducts', $products->id) }}" method="get">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-primary" style="margin-right: 10px;">Update</button>
                                            </form>
                                            <form action="{{ url('deleteProducts', $products->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
